      subroutine mkvtk_phi_nj(svall,nstep,dx,dy,dz,q)
      implicit none
...
!$OMP  END PARALLEL DO
      ...
      write(fname,'("phi(nj)_",i7.7,".vtk")')nstep
      open(10,file=fname,status='replace')
      write(10,"('# vtk DataFile Version 2.0')")
      write(10,"('t=',I0)")nstep
      write(10,"('ASCII')")
      write(10,"('DATASET STRUCTURED_POINTS')")
      write(10,"('DIMENSIONS ',I0,' ',I0,' ',I0)")mi+1,2,mk+1
      write(10,"('ORIGIN ',e11.4,' ',e11.4,' ',e11.4)")0.0,(mj-1)*dy,0.0
      write(10,"('ASPECT_RATIO ',e11.4,' ',e11.4,' ',e11.4)")dx,dy,dz
      write(10,"('')")
      write(10,"('POINT_DATA ',I0)")(mi+1)*2*(mk+1)
