...
ccc 
      ...
      subroutine cal_harm_coef_vis(ni,nj,nk,dxinv,dyinv,dzinv
     & ,    rmuk
...
!$OMP$ SHARED(aw_wb_uk,aw_eb_uk,aw_wt_uk,aw_et_uk)
      ...
      rmu_xp= rmuk(i+1,j  ,k  )
      rmu_ym=4.0d0/(
     1       +1.0d0/rmuk(i  ,j-1,k  )
     2       +1.0d0/rmuk(i+1,j-1,k  )
     3       +1.0d0/rmuk(i  ,j  ,k  )
     4       +1.0d0/rmuk(i+1,j  ,k  ))
      rmu_yp=4.0d0/(
     1       +1.0d0/rmuk(i  ,j  ,k  )
     2       +1.0d0/rmuk(i+1,j  ,k  )
     3       +1.0d0/rmuk(i  ,j+1,k  )
     4       +1.0d0/rmuk(i+1,j+1,k  ))
      rmu_zm=4.0d0/(
     1       +1.0d0/rmuk(i  ,j  ,k-1)
     2       +1.0d0/rmuk(i+1,j  ,k-1)
     3       +1.0d0/rmuk(i  ,j  ,k  )
     4       +1.0d0/rmuk(i+1,j  ,k  ))
      rmu_zp=4.0d0/(
     1       +1.0d0/rmuk(i  ,j  ,k  )
     2       +1.0d0/rmuk(i+1,j  ,k  )
     3       +1.0d0/rmuk(i  ,j  ,k+1)
     4       +1.0d0/rmuk(i+1,j  ,k+1))
...
!$OMP$ SHARED(aw_sb_vk,aw_nb_vk,aw_st_vk,aw_nt_vk)
      ...
      rmu_xm=4.0d0/(
     1       +1.0d0/rmuk(i-1,j  ,k  )
     2       +1.0d0/rmuk(i  ,j  ,k  )
     3       +1.0d0/rmuk(i-1,j+1,k  )
     4       +1.0d0/rmuk(i  ,j+1,k  ))
      rmu_xp=4.0d0/(
     1       +1.0d0/rmuk(i  ,j  ,k  )
     2       +1.0d0/rmuk(i+1,j  ,k  )
     3       +1.0d0/rmuk(i  ,j+1,k  )
     4       +1.0d0/rmuk(i+1,j+1,k  ))
      ...
      rmu_zm=4.0d0/(
     1       +1.0d0/rmuk(i  ,j  ,k-1)
     2       +1.0d0/rmuk(i  ,j+1,k-1)
     3       +1.0d0/rmuk(i  ,j  ,k  )
     4       +1.0d0/rmuk(i  ,j+1,k  ))
      rmu_zp=4.0d0/(
     1       +1.0d0/rmuk(i  ,j  ,k  )
     2       +1.0d0/rmuk(i  ,j+1,k  )
     3       +1.0d0/rmuk(i  ,j  ,k+1)
     4       +1.0d0/rmuk(i  ,j+1,k+1))
...
!$OMP$ SHARED(av_bs_wk,av_ts_wk,av_bn_wk,av_tn_wk)
     ...
     1       +1.0d0/rmuk(i-1,j  ,k  )
     2       +1.0d0/rmuk(i  ,j  ,k  )
     3       +1.0d0/rmuk(i-1,j  ,k+1)
     4       +1.0d0/rmuk(i  ,j  ,k+1))
      rmu_xp=4.0d0/(
     1       +1.0d0/rmuk(i  ,j  ,k  )
     2       +1.0d0/rmuk(i+1,j  ,k  )
     3       +1.0d0/rmuk(i  ,j  ,k+1)
